...
export class AutoGenerated1758864963640 implements MigrationInterface {
    name = 'AutoGenerated1758864963640'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "courses" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying(160) NOT NULL, "description" text, "category" character varying(80), "currency" character varying(10) NOT NULL DEFAULT 'INR', "price" integer NOT NULL DEFAULT '0', "status" character varying(20) NOT NULL DEFAULT 'DRAFT', "thumbnail_url" character varying(512), "content_outline" jsonb, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "published_at" TIMESTAMP WITH TIME ZONE, "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "teacher_id" uuid, "organization_id" uuid, CONSTRAINT "PK_3f70a487cc718ad8eda4e6d58c9" PRIMARY KEY ("id"))`);
